                        ...
                        for($i = 0; $i < sizeof($posts); $i++){
                            ...
                            <div class="image"></div>
                                <div class="post-info">
                                    ...
                                    <p>Pievienoja <a href="profile.php?profileid='.$posts[sizeof($posts) - $i - 1]['author_id'].'" style="color: '.$posts[sizeof($posts) - $i - 1]['user_color'].'">'.$posts[sizeof($posts) - $i - 1]['username'].'</a></p>
                                </div>
                            </div>
